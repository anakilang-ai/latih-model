...
if __name__ == "__main__":
    file_path = 'rf1.csv'
    input_ids, attention_masks, labels, label_encoder = load_and_preprocess_data(file_path)
    train_dataset, val_dataset, test_dataset = create_datasets(input_ids, attention_masks, labels)
    train_model(train_dataset, val_dataset, num_labels=len(label_encoder.classes_))
