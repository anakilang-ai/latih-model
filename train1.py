...
def load_and_preprocess_data(filepath):
    ...
    return input_ids, attention_masks, labels, label_encoder
...
def create_model(num_labels):
    return TFRobertaForSequenceClassification.from_pretrained('roberta-base', num_labels=num_labels)
...
def main():
    input_ids, attention_masks, labels, label_encoder = load_and_preprocess_data('rf1.csv')
    train_dataset, val_dataset, test_dataset = split_dataset(input_ids, attention_masks, labels)
